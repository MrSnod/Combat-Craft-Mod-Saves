...
import net.mcreator.combatcraftmodv.item.GhostMatterItem;
...
public class CombatcraftmodvModItems {
	...
	public static final RegistryObject<Item> GHOST_MATTER = REGISTRY.register("ghost_matter", () -> new GhostMatterItem());
