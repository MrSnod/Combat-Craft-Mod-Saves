...
public class AlternateForestLeaveDecorator extends LeaveVineDecorator {
	public static final AlternateForestLeaveDecorator INSTANCE = new AlternateForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("alternate_forest_tree_leave_decorator");
