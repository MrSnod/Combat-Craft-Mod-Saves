...
import net.mcreator.combatcraftmodv.procedures.NecronSwordToolInHandTickProcedure;
...
public class NecronSwordItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Scyla"));
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			NecronSwordToolInHandTickProcedure.execute(entity);
	}
}
